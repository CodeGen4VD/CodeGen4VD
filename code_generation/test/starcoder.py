...
model_id = "/home/llm/transformers/starcoder"
...
fillpath = '/home/llm/data/8_test/fill/starcoder/'
fullpath = '/home/llm/data/8_test/full/starcoder/'
...
for function_name in function_line:
    ...
    for line in function_line[function_name]:
        ...
        try:
            ...
            with open('./starcoder_log.txt','w') as f:
                f.write(fullfile)   
