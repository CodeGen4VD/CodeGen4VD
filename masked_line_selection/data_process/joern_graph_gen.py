...
def parse_options():
    ...
    parser.add_argument('-i ', '--input', help='The dir path of input', type=str,default='/home/llm/data/2-normalize/')
    parser.add_argument('-o ', '--output', help='The dir path of output', type=str,default='/home/llm/data/3-parse/')
    parser.add_argument('-t ', '--type', help='The type of procedures: parse or export', type=str, default='parse')
    parser.add_argument('-r ', '--repr', help='The type of representation: pdg or lineinfo_json', type=str, default='json')
...
def main():
    joern_path = '/home/llm/joern/joern-1.1.172/joern-cli'
    os.chdir(joern_path)
    args = parse_options()
    type = args.type
    repr = args.repr
    vuls = ['novul','vul']
    for vul in vuls:
        input_path = os.path.join(args.input,vul)
        output_path = os.path.join(args.output,repr,vul)
        p = Path(output_path)
